...
class InjectableConfigModule extends Module {
  ...
  override def bindings(environment: Environment, configuration: Configuration): Seq[Binding[_]] = {
    configuration.entrySet.toSeq.flatMap { case (key, value) =>
      bind(key, value)
    }
  }
  ...
  private def bindNumber(key: String, value: ConfigValue): List[Binding[_]] = {
    ...
    value.unwrapped() match {
      ...
      case i: java.lang.Integer => List(bind[java.lang.Integer].qualifiedWith(qualifier).toInstance(i))
      case l: java.lang.Long => List(bind[java.lang.Long].qualifiedWith(qualifier).toInstance(l))
      case _ => Nil
    }
  }
